...
type FileUploadServiceClient interface {
	...
	CreateBookmarkFileWithAuth(ctx context.Context, in *CreateBookmarkFileRequest, opts ...grpc.CallOption) (*CreateBookmarkFileResponse, error)
...
func (c *fileUploadServiceClient) CreateBookmarkFileWithAuth(ctx context.Context, in *CreateBookmarkFileRequest, opts ...grpc.CallOption) (*CreateBookmarkFileResponse, error) {
	out := new(CreateBookmarkFileResponse)
	err := c.cc.Invoke(ctx, "/filestorage.FileUploadService/CreateBookmarkFileWithAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileUploadServiceServer interface {
	...
	CreateBookmarkFileWithAuth(context.Context, *CreateBookmarkFileRequest) (*CreateBookmarkFileResponse, error)
...
func (UnimplementedFileUploadServiceServer) CreateBookmarkFileWithAuth(context.Context, *CreateBookmarkFileRequest) (*CreateBookmarkFileResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBookmarkFileWithAuth not implemented")
}
...
func _FileUploadService_CreateBookmarkFileWithAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateBookmarkFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileUploadServiceServer).CreateBookmarkFileWithAuth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/filestorage.FileUploadService/CreateBookmarkFileWithAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileUploadServiceServer).CreateBookmarkFileWithAuth(ctx, req.(*CreateBookmarkFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileUploadService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateBookmarkFileWithAuth",
			Handler:    _FileUploadService_CreateBookmarkFileWithAuth_Handler,
		},
		{
